...
Kaban's operations were struggling with manual, paper-based inefficiencies:
...
A centralized, **ACID-compliant** financial platform that ensures data integrity, real-time balance updates,
and secure role-based access control (RBAC). It transforms banking from a manual struggle into a streamlined,
automated, and secure digital experience.
...
* **Capabilities:**
    ...
    * View customer profiles and account details within their branch.
...
### Branches (Divisions)
*Each user is assigned to a specific branch for localized management.*
...
* **Recent Activity:** The last 5 transactions.
...
* **Currency:** We track **Currency (PHP)**.
...
* **Cloud:** AWS Free Tier (EC2 t3.micro, RDS Single-AZ, S3)
